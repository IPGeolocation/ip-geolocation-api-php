...
/**
 * BulkIPRequest Class Doc Comment
 *
 * @category Class
 * @package  Ipgeolocation\Sdk
 * @author   Ipgeolocation team
 ...
 */
class BulkIPRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $ipgeoapiModelName = 'getBulkIpGeolocation_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['ips']) && (count($this->container['ips']) > 50000)) {
            $invalidProperties[] = "invalid value for 'ips', number of items must be less than or equal to 50000.";
        }
    ...
    public function setIps($ips)
    {
        ...
        if ((count($ips) > 50000)) {
            throw new \InvalidArgumentException('invalid value for $ips when calling BulkIPRequest., number of items must be less than or equal to 50000.');
        }
