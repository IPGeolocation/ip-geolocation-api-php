 ...
 */
class NetworkAsn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $ipgeoapiModelName = 'Network_asn';
    ...
    */
     ...
     *
     * @param string|null $num_of_ipv4_routes num_of_ipv4_routes
     *
     * @return self
     */
     ...
     *
     * @param string|null $num_of_ipv6_routes num_of_ipv6_routes
     *
     * @return self
     */
