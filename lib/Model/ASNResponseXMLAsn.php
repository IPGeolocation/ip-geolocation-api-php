...
/**
 * ASNResponseXMLAsn Class Doc Comment
 *
 * @category Class
 * @package  Ipgeolocation\Sdk
 * @author   Ipgeolocation team
 ...
 */
class ASNResponseXMLAsn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $ipgeoapiModelName = 'ASNResponseXML_asn';
    ...
    */
     ...
     * Sets date_allocated
     *
     * @param \DateTime|null $date_allocated date_allocated
     *
     * @return self
     */
     ...
     * Sets upstreams
     *
     * @param \Ipgeolocation\Sdk\\Model\ASNConnection[]|null $upstreams upstreams
     *
     * @return self
     */
     ...
     * Sets downstreams
     *
     * @param \Ipgeolocation\Sdk\\Model\ASNConnection[]|null $downstreams downstreams
     *
     * @return self
     */
     ...
     * Sets peers
     *
     * @param \Ipgeolocation\Sdk\\Model\ASNConnection[]|null $peers peers
     *
     * @return self
     */
     ...
     * Sets whois_response
     *
     * @param string|null $whois_response whois_response
     *
     * @return self
     */
