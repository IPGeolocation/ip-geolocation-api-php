...
/**
 * AstronomyXMLResponse Class Doc Comment
 *
 * @category Class
 * @package  Ipgeolocation\Sdk
 * @author   Ipgeolocation team
 ...
 */
class AstronomyXMLResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $ipgeoapiModelName = 'AstronomyXMLResponse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('astronomy', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['astronomy'];
    }
    ...
    {
        if (is_null($astronomy)) {
            throw new \InvalidArgumentException('non-nullable astronomy cannot be null');
        }
        $this->container['astronomy'] = $astronomy;
