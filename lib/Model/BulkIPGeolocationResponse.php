...
/**
 * BulkIPGeolocationResponse Class Doc Comment
 *
 * @category Class
 * @package  Ipgeolocation\Sdk
 * @author   Ipgeolocation team
 ...
 */
class BulkIPGeolocationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $ipgeoapiModelName = 'getBulkIpGeolocation_200_response_inner';
