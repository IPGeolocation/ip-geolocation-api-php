...
/**
 * BulkUserAgentRequest Class Doc Comment
 *
 * @category Class
 * @package  Ipgeolocation\Sdk
 * @author   Ipgeolocation team
 ...
 */
class BulkUserAgentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $ipgeoapiModelName = 'parseBulkUserAgentStrings_request';
    ...
    {
        $this->setIfExists('ua_strings', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['ua_strings'];
    }

    /**
     * Sets ua_strings
     *
     * @param string[]|null $ua_strings ua_strings
     *
     * @return self
     */
    public function setUaStrings($ua_strings)
    {
        if (is_null($ua_strings)) {
            throw new \InvalidArgumentException('non-nullable ua_strings cannot be null');
        }
        $this->container['ua_strings'] = $ua_strings;
