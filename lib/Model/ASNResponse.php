 ...
 */
class ASNResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $ipgeoapiModelName = 'ASNResponse';
    ...
    protected static $ipgeoapiTypes = [
        'ip' => 'string',
        'asn' => '\Ipgeolocation\Sdk\\Model\ASNDetails'
    ];
    ...
    */
     ...
     * Sets ip
     *
     * @param string|null $ip IP address for which ASN information is returned. Present if the 'ip' query parameter is used or no IP is specified (defaults to requester's IP).
     *
     * @return self
     */
     ...
     * Gets asnDetails
     *
     * @return \Ipgeolocation\Sdk\\Model\ASNDetails|null
     */
     ...
     * Sets asnDetails
     *
     * @param \Ipgeolocation\Sdk\\Model\ASNDetails|null $asnDetails asnDetails
     *
     * @return self
     */
