...
class Location implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $ipgeoapiModelName = 'Location';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('dma_code', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $accuracy_radius accuracy_radius
     *
     * @return self
     */
    public function setAccuracyRadius($accuracy_radius)
    {
        if (is_null($accuracy_radius)) {
            throw new \InvalidArgumentException('non-nullable accuracy_radius cannot be null');
        }
    ...
    {
        return $this->container['dma_code'];
    }

    /**
     * Sets dma_code
     *
     * @param string|null $dma_code dma_code
     *
     * @return self
     */
    public function setDmaCode($dma_code)
    {
        if (is_null($dma_code)) {
            throw new \InvalidArgumentException('non-nullable dma_code cannot be null');
        }
        $this->container['dma_code'] = $dma_code;
