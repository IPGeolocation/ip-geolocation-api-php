...
/**
 * UserAgentRequest Class Doc Comment
 *
 * @category Class
 * @package  Ipgeolocation\Sdk
 * @author   Ipgeolocation team
 ...
 */
class UserAgentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $ipgeoapiModelName = 'parseUserAgentString_request';
    ...
    {
        $this->setIfExists('ua_string', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['ua_string'];
    }

    /**
     * Sets ua_string
     *
     * @param string|null $ua_string ua_string
     *
     * @return self
     */
    public function setUaString($ua_string)
    {
        if (is_null($ua_string)) {
            throw new \InvalidArgumentException('non-nullable ua_string cannot be null');
        }
        $this->container['ua_string'] = $ua_string;
