...
/**
 * AstronomyLocation Class Doc Comment
 *
 * @category Class
 * @package  Ipgeolocation\Sdk
 * @author   Ipgeolocation team
 ...
 */
class AstronomyLocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $ipgeoapiModelName = 'AstronomyLocation';
    ...
    */
     ...
     * Sets elevation
     *
     * @param string|null $elevation elevation
     *
     * @return self
     */
