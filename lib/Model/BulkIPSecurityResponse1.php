...
/**
 * BulkIPSecurityResponse1 Class Doc Comment
 *
 * @category Class
 * @package  Ipgeolocation\Sdk
 * @author   Ipgeolocation team
 ...
 */
class BulkIPSecurityResponse1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $ipgeoapiModelName = 'getBulkIpSecurityInfo_200_response_inner_1';
