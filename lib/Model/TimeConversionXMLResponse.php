...
/**
 * TimeConversionXMLResponse Class Doc Comment
 *
 * @category Class
 * @package  Ipgeolocation\Sdk
 * @author   Ipgeolocation team
 ...
 */
class TimeConversionXMLResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $ipgeoapiModelName = 'TimeConversionXMLResponse';
    ...
    */
     ...
     * Sets original_time
     *
     * @param string|null $original_time original_time
     *
     * @return self
     */
     ...
     * Sets converted_time
     *
     * @param string|null $converted_time converted_time
     *
     * @return self
     */
